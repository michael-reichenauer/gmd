...
class Upgrader
{
    ...
    {
        string oldStatePath = Path.Join(GetFolderPath(SpecialFolder.UserProfile), ".gmdstate.json");
        string newStatePath = Path.Join(GetFolderPath(SpecialFolder.UserProfile), ".gmdstate");
