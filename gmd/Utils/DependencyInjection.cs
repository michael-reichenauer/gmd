...
internal class DependencyInjection
{
    ...
    public T Resolve<T>()
        where T : notnull => container.Resolve<T>();
    ...
    public void RegisterAllAssemblyTypes()
    {
        try
        {
            ...
            DefaultConstructorFinder constructorFinder = new DefaultConstructorFinder(type =>
    ...
    private static bool IsSingleInstance(Type type) =>
        type.GetCustomAttributes(false).FirstOrDefault(obj => obj.GetType().Name == "SingleInstanceAttribute") != null;
}
